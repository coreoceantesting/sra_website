...
<section>
    ...
    <ol class="breadcrumb">
      <li class="breadcrumb-item"><a href="#">मुख्यपृष्ठ</a></li>
        ...
        <li class="breadcrumb-item active">सहकार विभाग</li>
        ...
        <div class="menus1">
          <nav>
                <ul id="respMenu" class="ace-responsive-menu collapse hide-menu" data-menu-style="">
                    ...
                    <li class="has-sub">
                        <a href="https://sra.gov.in/pagem/innerpage/coopertaive-department-marathi.php" target="" title="सहकार विभाग" class="activelm">सहकार विभाग</a>
...
<h3 class="page_heading">सहकार विभाग</h3>
<p>सहकार विभाग</p>
</div>
</div>
