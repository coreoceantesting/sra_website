...
<section>
    ...
    <ol class="breadcrumb">
      <li class="breadcrumb-item"><a href="#">मुख्यपृष्ठ</a></li>
        ...
        <li class="breadcrumb-item active">शासन निर्णय</li>
        ...
        <div class="menus1">
          <nav>
                <ul id="respMenu" class="ace-responsive-menu collapse hide-menu" data-menu-style="">
                    ...
                    <li class="has-sub">
                        <a href="https://www.sra.gov.in/pagem/innerpage/gis-mis-slum-data-marathi.php" target="" title="जीआयएस-एमआयएस झोपडपट्टी डेटा" class="">जीआयएस-एमआयएस झोपडपट्टी डेटा</a>
                    ...
                    <li class="has-sub">
                        <a href="https://www.sra.gov.in/pagem/innerpage/https:grmaharashtragovin1145government-resolutions.php" target="" title="शासन निर्णय" class="activelm">शासन निर्णय</a>
...
<h3 class="page_heading">शासन निर्णय</h3>
<p>शासन निर्णय - <a href="https://gr.maharashtra.gov.in/1145/Government-Resolutions">https://gr.maharashtra.gov.in/1145/Government-Resolutions</a></p>
<p> </p>
</div>
</div>
