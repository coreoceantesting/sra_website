                ...
                <div class="row">
                            ...
                            <div class="menus1">
                                <nav>
                                    <ul id="respMenu" class="ace-responsive-menu collapse hide-menu" data-menu-style="">
                                        ...
                                        <li class="has-sub">
                                            <a href="{{route('gismisslumdatamarathi')}}" target="" title="जीआयएस-एमआयएस झोपडपट्टी डेटा" class="activelm">जीआयएस-एमआयएस झोपडपट्टी डेटा</a>
                    ...
                    <div class="col-md-9 col-xs-12">
                        <div class="content-div">
                            ...
                            <ul>
                                <li><a href="{{ asset('storage/pdf/ca_setallite.pdf')}}" target="_blank" rel="noopener">Slum Cluster map with Ward & Village Boundaries (Satellite Imagery)</a><img src="https://www.sra.gov.in/assets/themes/images/blinking_new.gif" alt="New" width="30" height="20"
                                    /></li>
