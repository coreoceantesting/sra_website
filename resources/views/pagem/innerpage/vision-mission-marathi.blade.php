...
<section>
    ...
    <ol class="breadcrumb">
      <li class="breadcrumb-item"><a href="#">मुख्यपृष्ठ</a></li>
        ...
        <li class="breadcrumb-item active">हेतू आणि ध्येय</li>
        ...
        <div class="menus1">
          <nav>
                <ul id="respMenu" class="ace-responsive-menu collapse hide-menu" data-menu-style="">
                    ...
                    <li class="has-sub">
                        <a href="{{ route('vision-mission-marathi') }}" target="" title="हेतू आणि ध्येय" class="activelm">हेतू आणि ध्येय</a>
...
<h3 class="page_heading">हेतू आणि ध्येय</h3>
<h3 style="text-align: center;"> </h3>
<h3 style="text-align: center;">झोपडपट्टी मुक्त मुंबई</h3>
</div>
</div>
